...
def compute_doc_embeddings(df: pd.DataFrame) :
    ...
    """
    return {
        idx: get_embedding(r['学科']+':'+r['去向']) for idx, r in df.iterrows()
    }
...
#========下面的逻辑是我们尽量给question,匹配相关上下文,直到扩充到500.MAX_SECTION_LEN目前是500,可以根据自己问题复杂性进行修改.
    for _, section_index in most_relevant_document_sections:
        ...
        tmp=document_section['学科']+':'+document_section['去向']
...
print(answer_query_with_context("数学竞赛的队员去清华的比去北大的人多几个?", df, document_embeddings))
